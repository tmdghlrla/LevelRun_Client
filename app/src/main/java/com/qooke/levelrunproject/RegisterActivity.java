...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgKakaoLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(UserApiClient.getInstance().isKakaoTalkLoginAvailable(RegisterActivity.this)) {
                    UserApiClient.getInstance().loginWithKakaoTalk(RegisterActivity.this, callback);
                } else {
                    UserApiClient.getInstance().loginWithKakaoAccount(RegisterActivity.this, callback);
                }
            }
        });
    }
    ...
    private void createAccount() {
        ...
        MyAppUser user = new MyAppUser(nickName, email, password);
            ...
            public void onResponse(Call<UserRes> call, Response<UserRes> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if(result.contains("이메일")) {
                        Toast.makeText(RegisterActivity.this, "해당 이메일 주소로 가입된 정보가 있습니다.", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    else if(result.contains("닉네임")) {
                        Toast.makeText(RegisterActivity.this, "해당 닉네임으로 가입된 정보가 있습니다.", Toast.LENGTH_SHORT).show();
                        return;
                    }
    ...
    private void kakaoLogin() {
        ...
        call.enqueue(new Callback<UserRes>() {
            ...
            public void onFailure(Call<UserRes> call, Throwable t) {
                ...
                Toast.makeText(RegisterActivity.this, "네트워크 파싱 오류입니다.", Toast.LENGTH_SHORT).show();
            }
        });
    }
